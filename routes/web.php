...
Route::middleware('isLogin')->group(function () {
    ...
    Route::post('/product/goods/update/{id}', [ProdukController::class, 'update'])->name('goods.update');
    Route::get('/product/goods/delete/{id}', [ProdukController::class, 'delete'])->name('goods.delete');
    Route::post('/product/stock/{id}', [ProdukController::class, 'UpdateStock'])->name('stock');
